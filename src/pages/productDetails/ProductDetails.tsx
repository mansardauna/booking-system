...
const ProductDetail: React.FC<InfoProps> = ({ productInfo }) => {
  ...
  return (
    ...
    <div className="flex w-full m-auto md:flex-row flex-col gap-3 mt-4 ">
      ...
      <Button variant="primary" className="flex rounded-md items-center text-white gap-1">
        <HeartAdd size={14} />
        <div className=" text-xs">Add to Favourites</div>
      </Button>
      </div>
   ...
   {isBooked ? (
        ...
        <div className="md:w-7/12 w-10/12 mt-5 m-auto p-4 border">
          ...
          <div className="md:flex gap-2 items-center p-2">
            ...
            <input type="text" value={event} onChange={(e) => setEventName(e.target.value)} className="border p-2 rounded-md uppercase bg-transparent"
           />
          </div>
          ...
          <div className="md:flex gap-2 items-center p-2">
            ...
            <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} className="border p-2 rounded-md uppercase bg-transparent" />
          </div>
